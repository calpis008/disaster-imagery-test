...
const getGlobalConstants = (app, envConfig) => {
    ...
    return {
         ...
         */
        ENV_DMC_EXPLORER_APP_ID: JSON.stringify(
            envConfig.DMC_EXPLORER_APP_ID
        ),
        /**
         * Service URL for the DMC III ImageServer.
         */
        ENV_DMC_SERVICE_URL: JSON.stringify(
            envConfig.DMC_SERVICE_URL
        ),
        /**
         * Application ID for the FS-8 (FORMOSAT-8) Explorer app.
         */
        ENV_FS8_EXPLORER_APP_ID: JSON.stringify(
            envConfig.FS8_EXPLORER_APP_ID
        ),
        /**
         * Service URL for the FORMOSAT-8 ImageServer.
         */
        ENV_FS8_SERVICE_URL: JSON.stringify(
            envConfig.FS8_SERVICE_URL
        ),
    };
};
