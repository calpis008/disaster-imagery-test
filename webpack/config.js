...
const ENTRY_POINTS_BY_APP_NAME = {
    ...
    dmcexplorer: './src/dmc-explorer/index.tsx',
    fs8explorer: './src/fs8-explorer/index.tsx',
    unifiedexplorer: './src/unified-explorer/index.tsx',
};
...
const ENV_VARIABLES_BY_APP_NAME = {
    ...
    dmcexplorer: [
        {
            name: 'DMC_EXPLORER_APP_ID',
            required: false,
        },
        {
            name: 'DMC_SERVICE_URL',
            required: false,
        },
    ],
    fs8explorer: [
        {
            name: 'FS8_EXPLORER_APP_ID',
            required: false,
        },
        {
            name: 'FS8_SERVICE_URL',
            required: false,
        },
    ],
    unifiedexplorer: [
